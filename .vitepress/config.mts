          ...
          { text: 'Quickstart', link: '/docs/cli/quickstart/' },
          {
            ...
            items: [
              ...
              },
              {
                ...
                link: '/docs/format/',
                collapsed: true,
                items: [{ text: 'Quickstart', link: '/docs/format/tutorial/' }],
              },
              { text: 'Call Protobuf APIs', link: '/docs/curl/' },
              {
                ...
                link: '/docs/build/',
                collapsed: true,
                items: [{ text: 'Quickstart', link: '/docs/build/tutorial/' }],
              },
              {
        ...
        items: [
          ...
          },
          {
            ...
            items: [
              {
                text: 'Docker',
                link: '/docs/bufstream/deployment/docker/',
              },
              {
                text: 'AWS',
                collapsed: true,
          ...
          {
            text: 'Architecture',
            link: '/docs/bufstream/architecture/',
            collapsed: true,
            items: [
              {
                text: 'Kafka data flow',
                link: '/docs/bufstream/architecture/kafka-flow/',
              },
              {
                text: 'Network architecture',
                link: '/docs/bufstream/architecture/bufstream-network-deployment-guide/',
              },
            ],
          },
