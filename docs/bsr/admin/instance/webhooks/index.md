...
::: tip NoteIn the samples below, please use the domain name for your private BSR instance (for example, `https://buf.example.com`) in place of `BSR_INSTANCE_DOMAIN_NAME`.
