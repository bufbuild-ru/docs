...
The starting code for this tutorial contains a `InvoiceServerTest` unit test in `invoice_server_test.py`. It starts a server with a Protovalidate interceptor and iterates through a series of test cases.
