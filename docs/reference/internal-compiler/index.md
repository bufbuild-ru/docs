...
Additionally, there are many situations outside of stub generation that rely on proper Protobuf parsing, such as [linting](../../lint/) and [breaking change detection](../../breaking/). All existing Protobuf tooling has gone one of two routes:
...
Having this new compiler is a key component of Buf's future. Right now, it enables reliable [linting](../../lint/), [breaking change detection](../../breaking/), [generation](../../generate/tutorial/), and the [BSR](../../bsr/). In the future, it enables a lot of other real-time possibilities for us.
